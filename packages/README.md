...
- `@yokai-internal/core`: private orchestration and runtime primitives.
- `@yokai-internal/mind`: private roleplay decision and expression logic.
- `@yokai-internal/memory`: private archive and memory capabilities.
